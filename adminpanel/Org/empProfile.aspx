<%@ Page Title="" Language="C#" MasterPageFile="~/Client/ClientManager.Master" AutoEventWireup="true" CodeBehind="empProfile.aspx.cs" Inherits="adminpanel.Client.empProfile" %>
...
<div class="modal inmodal fade" id="myMapModal">
            <div class="modal-dialog">
                <div class="modal-content">
        ...
        <div class="modal inmodal fade" id="viewImageDialog" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated fadeIn">
                    <div class="modal-body">
                        <div class="row">
        ...
        <div class="modal inmodal fade" id="viewMapDialog" style="min-width: 100%; min-height: 100%; height: auto" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated fadeIn">
                    <div class="modal-body">
...
<asp:Content ID="Content3" ContentPlaceHolderID="javascriptPart" runat="server">
    ...
    <script>
        ...
        var attendanceURL = "../api/attendance/of/temp/" + gEmpId;
        ...
        function showFoo() {
            fnExportHTML("jsonTable", "#87AFC6", "lakshman");
            return false;
        }
